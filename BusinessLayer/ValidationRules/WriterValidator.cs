...
{
    public class WriterValidator : AbstractValidator<WriterProfileEditDto>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterPassword).MinimumLength(6).WithMessage("Lütfen en az 6 karekter girişi yapınız");
